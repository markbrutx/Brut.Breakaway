...
{
	public class BreakawaySettings : AttributeGlobalSettings<BreakawaySettings>, INotifyPropertyChanged
	{
		...
		private const string ModuleName = "Brut.Breakaway";

		static BreakawaySettings()
		{
			modVersion = ModuleHelper.GetModules().SingleOrDefault(x => x.Name == ModuleName)?.Version.ToString() ?? string.Empty;
			modName = $"Brut.Breakaway {modVersion}";
			modId = $"{ModuleName}_{modVersion}";
		}
		public BreakawaySettings()
		{
			friendThreshold = 10;
			enemyThreshold = -10;
		...
		public override string FolderName => ModuleName;
		...
		public int MinimalNumberOfWarsPerChaosKindom { get; set; } = 0;
		...
		public int MinimalAmountOfKingdomFiefsToRebel { get; set; } = 5;
		...
		public float DailyLordRebellionChance { get; set; } = 0.1f;
		...
		public int MinimalRequiredNumberOfNativeLords { get; set; } = 3;
		...
		public float DailyNationalRebellionChance { get; set; } = 0.05f;
		...
		public int CriticalAmountOfFiefsPerSingleClan { get; set; } = 12;
		...
		public int NumberOfDaysAfterOwnerVisitToKeepOrder { get; set; } = 21;
		...
		public bool BonusRebelFiefForHighTierClan { get; set; } = false;
		...
		public float DailyAnarchyRebellionChance { get; set; } = 0.05f;
